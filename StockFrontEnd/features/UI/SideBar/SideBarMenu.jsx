...
export default function SideBarMenu() {
    ...
    return (
        <div className="gxe9ll0 _1kestwgs _1kestwg4 gxe9ll2 _17lx8ak1" data-tabster='{"mover":{"cyclic":false,"direction":1,"memorizeCurrent":true,"tabbable":true}}' style={{ display: "flex", flexDirection: "column", gap: "0px", justifyContent: "normal", alignItems: "center", visibility: "visible" }}>
            ...
            <nav className="gxe9ll4">
                <button aria-label="리모콘 닫기" className="gxe9ll5 gxe9ll7" data-state="closed" style={{ width: "24px", height: "48px" }}>
                ...
                {NAV_ITEMS.map((item, index) =>
                    item.hr ? <hr key={index} className="gxe9ll8" /> : (
                        <a key={item.label} className={`tw6g-1r5dc8g0 gxe9ll5 gxe9ll7${item.active ? " active" : ""}`} href={item.href} style={{ "--tds-wts-font-weight": "var(--tw-font-weight-regular)", "--tds-wts-foreground-color": "var(--wts-adaptive-greyOpacity800)", "--tds-wts-line-height": "1.45", "--tds-wts-font-size": "12px" }}>
                            <div className="gxe9ll6">
            ...
            <div>
                <button className="tw6g-1r5dc8g0 gxe9ll5" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-_r_12_" data-state="closed" style={{ "--tds-wts-font-weight": "var(--tw-font-weight-regular)", "--tds-wts-foreground-color": "var(--wts-adaptive-greyOpacity800)", "--tds-wts-line-height": "1.45", "--tds-wts-font-size": "15px" }}>
                    <div className="gxe9ll6">
                        <span className="tw6g-17xiat90 tw6g-17xiat91" aria-hidden="true" role="presentation" style={{ height: "20px", width: "20px", minWidth: "20px", color: "inherit" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px", justifyContent: "normal", alignItems: "center" }}>
                    {ICON_BUTTONS.map((btn) => (
                        <button key={btn.label} className="tw6g-emtxt715 tw6g-emtxt7o tw6g-emtxt7y tw6g-emtxt712 _1xoykgb0" aria-disabled="false" aria-label={btn.label} data-theme="grey" data-variant="weak" data-mode="dark" data-state="closed">
