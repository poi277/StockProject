    ...
    return (
        <section>
            <div style={{ display: "flex", flexDirection: "row", gap: "0px", justifyContent: "space-between", alignItems: "center", height: "24px" }}>
                <a className="_1h1d45d1" href="/investment-portfolio">
                    <div style={{ display: "flex", flexDirection: "row", gap: "0px", justifyContent: "normal", alignItems: "center" }}>
                        <span className="tw6g-1r5dc8g0" size="15" data-state="closed" style={{ lineHeight: "1.45", "--tds-wts-font-weight": "var(--tw-font-weight-bold)", "--tds-wts-foreground-color": "var(--wts-adaptive-grey800)", "--tds-wts-line-height": "1.45", "--tds-wts-font-size": "15px" }}>내 투자</span>
                ...
                <div style={{ display: "flex", flexDirection: "row", gap: "6px", justifyContent: "space-between", alignItems: "center" }}>
                    <button className="tw6g-emtxt715 tw6g-emtxt7p tw6g-emtxt7u tw6g-emtxt710" aria-disabled="false" aria-label="내 투자 접기" data-theme="grey" data-variant="clear" data-mode="dark" aria-hidden="true" data-state="closed" style={{ marginRight: "-6px" }}>
            ...
            <div className="_1h1d45d0" style={{ display: "flex", flexDirection: "column", height: "auto", marginTop: "0px", marginBottom: "12px", opacity: 1 }}>
                <a className="_11fusij0 tw6g-gduhvu0" href="/investment-portfolio">
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: "0px", justifyContent: "normal", alignItems: "normal", flex: "1 1 0%", minHeight: "0px" }}>
            <div style={{ display: "flex", flexDirection: "row", gap: "0px", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div role="radiogroup" aria-required="false" dir="ltr" className="tw6g-1sni4y90 tw6g-1sni4y91 tw6g-1sni4y95" aria-label="평가금에서 현재가로" tabIndex={0} style={{ outline: "none" }} data-scrollable="false">
                    ...
                    {SEGMENT_ITEMS.map((item) => (
                        <button key={item.label} type="button" role="radio" aria-checked={item.checked} data-state={item.state} value={item.value} className="tw6g-1cq3gqg0 tw6g-1cq3gqg2" data-seg-state={item.state} tabIndex={-1} data-radix-collection-item>
                                    ...
                                    <div className="tw6g-1e8fj1aa tw6g-1e8fj1ad tw6g-1e8fj1ac tw6g-1e8fj1ag" style={{ gridTemplateColumns: "minmax(0px, 1fr) max-content" }}>
                                        <span className="tw6g-1e8fj1am">
                                            <div className="tw6g-1ia8ofc0 tw6g-1ia8ofc1">
                                                <span className="tw6g-1r5dc8g0 fmiok60" style={{ "--tds-wts-font-weight": "var(--tw-font-weight-semibold)", "--tds-wts-foreground-color": "var(--wts-adaptive-greyOpacity800)", "--tds-wts-line-height": "1.45", "--tds-wts-font-size": "14px" }}>
                                                    <span>{stock.stockName}</span>
                                                </span>
                                                <span className="tw6g-1r5dc8g0" style={{ "--tds-wts-font-weight": "var(--tw-font-weight-medium)", "--tds-wts-foreground-color": "var(--wts-adaptive-grey600)", "--tds-wts-line-height": "1.45", "--tds-wts-font-size": "12px" }}>
                                                    {stock.quantity + "주"}
                                                </span>
                                            </div>
                                        </span>
