        ...
        <>
            <div ref={popoverRef}>
                <div data-radix-popper-content-wrapper style={{ position: "fixed", left: "0px", top: "0px", transform: "translate(1299px, 823px)", minWidth: "max-content", "--radix-popper-transform-origin": "250px 0%", zIndex: 1, "--radix-popper-available-width": "1529px", "--radix-popper-available-height": "913px", "--radix-popper-anchor-width": "297px", "--radix-popper-anchor-height": "49px" }}>
                    <div data-side="left" data-align="start" data-state="open" role="dialog" id="radix-_r_16d_" aria-labelledby="radix-_r_16b_" aria-describedby="radix-_r_16c_" className="tw6g-gduhvu0 tw6g-1h3jdxo4 tw6g-1h3jdxo6 tw6g-1h3jdxo5 dgtq08" data-overlay-type="Popover" data-section-name="Popover__ConfirmCancelPopover" tabIndex={-1} style={{ "--tw6g-1h3jdxo0": "10px", "--radix-popover-content-transform-origin": "var(--radix-popper-transform-origin)", "--radix-popover-content-available-width": "var(--radix-popper-available-width)", "--radix-popover-content-available-height": "var(--radix-popper-available-height)", "--radix-popover-trigger-width": "var(--radix-popper-anchor-width)", "--radix-popover-trigger-height": "var(--radix-popper-anchor-height)", opacity: 1, transform: "none" }}>
                        ...
                        <button onClick={executeCancel} type="button" aria-disabled="false" className="tw6g-1wkoka52h tw6g-1wkoka50 tw6g-1wkoka541 tw6g-1wkoka5f tw6g-1wkoka519 tw6g-1wkoka5z tw6g-1wkoka5s tw6g-1wkoka5n tw6g-1wkoka52a tw6g-1h3jdxoa tw6g-1h3jdxob" data-tds-wts-button data-tossinvest-log="Popover.Button" data-parent-name="ConfirmCancelPopover" data-tds-wts-popover-button data-contents-label="취소하기" data-contents-label-code="buttonText" data-contents-value="취소하기" data-content-tag="buttonText">
