    ...
    <div className="_1sivumi0 _1sivumi2">
      <div style={{ display: 'flex', flexDirection: 'row', gap: '0px', alignItems: 'center' }}>
        ...
        <div className="_1p5yqoh0 _1sivumia" style={{ display: 'flex', alignItems: 'center', marginLeft: '2px' }}>
          ...
          <span className="tw3v-1r5dc8g0" style={{ '--tds-wts-font-weight': 'var(--tw-font-weight-semibold)', '--tds-wts-foreground-color': stock.changeAmount < 0 ? 'var(--wts-adaptive-blue500)' : 'var(--wts-adaptive-red500)', '--tds-wts-line-height': '1.45', '--tds-wts-font-size': '14px' }}>{stock.changeAmount.toLocaleString()}원({stock.changeRate}%)</span>
        </div>
